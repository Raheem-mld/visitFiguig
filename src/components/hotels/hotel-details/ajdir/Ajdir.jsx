    ...
    <div>
      ...
      <div className="location">
        ...
        <div className="slogan-location">
          ...
          <Button onClick={handleOpen}><span className='location-text'>Ksar L'Oudaghir, Rue El Chaaba, Aït Youssef Ou Ali</span></Button>
          <Modal
            open={open}
            onClose={handleClose}
          ...
          >
            <Box sx={style}>
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3404068.5564816482!2d-7.091692786528404!3d33.57193061136644!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd74327c007f9e49%3A0x974d783a1e33417b!2sMaison%20d%20hote%20Ajdir%20Chez%20Dliam!5e0!3m2!1sfr!2sma!4v1680879350787!5m2!1sfr!2sma"
                width="600"
                height="450"
                style={{ border: "0" }}
                allowfullscreen=""
      ...
      <div className="location-info">
        ...
        <div className="left-info">
          <div className="up-info">
            ...
            <p className="info-text">Traditional house in ksar of L'Oudaghir built on two floors. Magnificent view of the panoramic terrace! Sunrise and sunset - sunbathing.
